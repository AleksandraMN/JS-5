...
const filteredProducts = products2.filter((products2) => products2.photos?.length); // первый способ - опциональная цепочка
//const filteredProducts = products2.filter((product) => product.photos > []; // второй способ
